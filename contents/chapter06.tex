...
\begin{enumerate}
    \item \textbf{Left-hand features are the strongest single-hand baseline.} The strongest single-hand baseline was left-hand XGB Importance + XGBoost, and the top-10 selected features aggregated across the three feature-selection methods were dominated by the left hand (25:5 and 19:11 in favour of the left hand). This is qualitatively compatible with the motor reserve hypothesis, but because subject-level handedness was not recorded, the result should be interpreted as an empirical left-versus-right asymmetry rather than direct evidence that the left hand was non-dominant for all subjects.
    ...
    \item \textbf{AGCN markedly improves within-cohort performance but does not transfer.} The AGCN reached AUROCs of approximately $0.98$ within each cohort under LOOCV. In cross-cohort transfer, however, AUROC collapsed to $0.59$, worse than the best hand-crafted feature configurations.
